...
PROJECT_DATE_UPDATED: str = "2025.08.31"
...
CARD_COORDINATE_X_HAND_PLAYER: int = int(GAME_WINDOW_WIDTH / 2)
CARD_COORDINATE_Y_HAND_PLAYER: int = int(
    CARD_TEXTURE_HEIGHT_SCALED / 2 + 
    CARD_TEXTURE_HEIGHT_SCALED / 4
    )
CARD_COORDINATE_X_HAND_OPPONENT: int = int(GAME_WINDOW_WIDTH / 2)
...
# Card slide settings:
CARD_SLIDE_DISTANCE_HOVER_HAND:  int   = int(CARD_TEXTURE_HEIGHT_SCALED / 4)
CARD_SLIDE_DISTANCE_HOVER_STACK: int   = int(CARD_TEXTURE_WIDTH_SCALED / 7)
CARD_SLIDE_DISTANCE_UNPLAYABLE:  int   = int(CARD_TEXTURE_HEIGHT_SCALED / 5)
CARD_SLIDE_SPEED:                int   = int(CARD_SLIDE_DISTANCE_HOVER_HAND / 8)
CARD_SLIDE_SPEED_MOD_DEFAULT:    float = 1.00
CARD_SLIDE_SPEED_MOD_INCREASED:  float = CARD_SLIDE_SPEED_MOD_DEFAULT * 1.25
CARD_SLIDE_SPEED_MOD_DOUBLE:     float = CARD_SLIDE_SPEED_MOD_INCREASED * 2.00
CARD_SLIDE_SPEED_OPPONENT:       int   = int(CARD_SLIDE_SPEED * 0.65)

# Hand settings:
HAND_SIZE_DEFAULT:         int = 6
HAND_BOUNDARY_MOD:       float = 0.70   # % occupied of all game window width
...
TABLE_COORDINATE_X:       int = int(GAME_WINDOW_WIDTH / 2)
TABLE_COORDINATE_Y:       int = int(GAME_WINDOW_HEIGHT / 2)
TABLE_POSITION_MARGIN:    int = int(CARD_TEXTURE_WIDTH_SCALED * 0.35)
TABLE_STACK_SHIFT_X:      int = int(CARD_TEXTURE_WIDTH_SCALED / 7)
TABLE_STACK_SHIFT_Y:      int = 0
...
TABLE_HEIGHT: int = int(
    CARD_TEXTURE_HEIGHT_SCALED + CARD_SLIDE_DISTANCE_HOVER_STACK
    )

# Area settings:
AREA_PLAYER_ONE_HAND_WIDTH: int = GAME_WINDOW_WIDTH
AREA_PLAYER_ONE_HAND_HEIGHT: int = int(CARD_TEXTURE_HEIGHT_SCALED * 2.00)
AREA_PLAYER_TWO_HAND_WIDTH: int = GAME_WINDOW_WIDTH
AREA_PLAYER_TWO_HAND_HEIGHT: int = int(CARD_TEXTURE_HEIGHT_SCALED * 2.00)
AREA_PLAYER_ONE_INDICATOR_COORDINATE_Y: int = 10
AREA_PLAYER_ONE_INDICATOR_WIDTH: int = GAME_WINDOW_WIDTH
AREA_PLYAER_ONE_INDICATOR_HEIGHT: int = 20
AREA_PLAYER_TWO_INDICATOR_COORDINATE_Y: int = int(GAME_WINDOW_HEIGHT - 10)
AREA_PLAYER_TWO_INDICATOR_WIDTH: int = GAME_WINDOW_WIDTH
AREA_PLAYER_TWO_INDICATOR_HEIGHT: int = 20

# Play settings:
PLAY_DELAY_SECONDS: int = 2
