...
PROJECT_DATE_UPDATED: str = "2025.11.11"
PROJECT_VERSION: str = "0.5.35"
...
ZONE_DECK_WIDTH: int = GAME_AREA_SIDE_WIDTH
ZONE_DECK_HEIGHT: int = int(GAME_AREA_SIDE_HEIGHT / 2)
ZONE_DISCARD_WIDTH: int = GAME_AREA_SIDE_WIDTH
ZONE_DISCARD_HEIGHT: int = int(GAME_AREA_SIDE_HEIGHT / 2)
...
ZONE_DECK_COORDINATE_X: int = GAME_AREA_SIDE_COORDINATE_X
ZONE_DECK_COORDINATE_Y: int = int(GAME_AREA_SIDE_COORDINATE_Y - ZONE_DECK_HEIGHT / 2)
ZONE_DISCARD_COORDINATE_X: int = GAME_AREA_SIDE_COORDINATE_X
ZONE_DISCARD_COORDINATE_Y: int = int(GAME_AREA_SIDE_COORDINATE_Y + ZONE_DISCARD_HEIGHT / 2)
...
ZONE_DECK_BG_COLOR: Color = arcade.color.LIGHT_APRICOT
ZONE_DISCARD_BG_COLOR: Color = arcade.color.LIGHT_CRIMSON
...
# Table stack coordinates settings:
TABLE_COORDINATE_CENTER_X: int = GAME_AREA_PLAY_COORDINATE_X
TABLE_COORDINATE_CENTER_Y: int = GAME_AREA_PLAY_COORDINATE_Y
TABLE_COORDINATE_SHIFT_X: int = int(CARD_TEXTURE_WIDTH_DEFAULT * 0.25)
TABLE_COORDINATE_SHIFT_Y: int = 0

# Table position settings:
TABLE_POSITION_GAP: int = int(CARD_TEXTURE_WIDTH_SCALED / 4)
...
DECK_RENDER_COORDINATE_X: int = int(
