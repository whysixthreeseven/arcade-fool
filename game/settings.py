...
PROJECT_DATE_UPDATED: str = "2025.09.20"
PROJECT_VERSION: str = "0.42h"
...
CARD_SLIDE_SPEED_DEFAULT: int = int(CARD_TEXTURE_HEIGHT_DEFAULT / 4)
CARD_SLIDE_SPEED_HAND_OUT: int = CARD_SLIDE_SPEED_DEFAULT
CARD_SLIDE_SPEED_HAND_INIT: int = int(CARD_SLIDE_SPEED_HAND_OUT / 2)
CARD_SLIDE_SPEED_TABLE_OUT: int = CARD_SLIDE_SPEED_HAND_OUT
CARD_SLIDE_SPEED_TABLE_INIT: int = CARD_SLIDE_SPEED_HAND_INIT
