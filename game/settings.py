...
PROJECT_DATE_UPDATED: str = "2025.09.08"
PROJECT_VERSION: str = "0.1a"
...
# Render settings:
DECK_RENDER_COORDINATE_X: int = 0
DECK_RENDER_COORDINATE_Y: int = 0
DECK_RENDER_COORDINATE_SHIFT_X: int = +1
DECK_RENDER_COORDINATE_SHIFT_Y: int = -1
DECK_RENDER_SHIFT_THRESHOLD: int = 8
...
HAND_PLAYER_ONE_COORDINATE_X: int = int(GAME_AREA_PLAY_WIDTH / 2)
HAND_PLAYER_ONE_COORDINATE_Y: int = int(
    CARD_TEXTURE_HEIGHT_SCALED / 2 + 
    CARD_TEXTURE_HEIGHT_SCALED / 4
    )
HAND_PLAYER_TWO_COORDINATE_X: int = int(GAME_AREA_PLAY_WIDTH / 2)
